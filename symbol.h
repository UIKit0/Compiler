...
/* ετσι αναπαριστανται οι τυποι */
/* refType οταν  εχουμε πινακα ή δείκτη 
/* το size χρησιμοποιείται όταν έχουμε array */
/* το ref count το αγνοουμε */
...
*  εδώ έχουμε ένα enumeration που μας λέει 
*  τα είδη ονομάτων που μπαίνουν μέσα στον πίνακα συμβόλων
*/
...
* enumeration για τον τρόπο περάσματος
*/
...
*  ένα struct που αναπριστά τις θέσεις του πίνακα συμβόλων 
*  για συντομία SymbolEntry
*  περιγραφή του union : 
*  Περιγράφει το στοιχείο ανάλογα με το τι είναι
*  -Μεταβλητές : έχουν τύπο 
*  -Σταθερες   : έχουν τύπο και ανάλογα με τον τύπο έχουν τις ανάλογες τιμές
*  -Συναρτήσεις: forward ή όχι η δήλωση της,δείκτες στο πρώτο και τελευταίο όρισμα,ο τύπος επιστροφής
*  -Παραμέτρους: έχουν τύπο,τρόπο περάσματος και δείκτη στην επόμενη παράμετρο
*  ΟΠΟΤΕ αν έχω μία εγγραφή και θέλω να αναγνωρίσω τι είναι κοιτάζω το entry type και έπειτα κοιτάζω το αντίστοιχο union
*/
